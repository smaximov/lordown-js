...
| `lordown.indent` | `true` | включить горячие клавиши для уменьшения/увеличения отступа? |
| `lordown.indent.modifier` | `ctrl` | клавиша-модификатор для уменьшения/увеличения отступа (`ctrl`, `alt`, `shift` или `meta`) |
