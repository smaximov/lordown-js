...
чтобы вернуть значение опции к значению по умолчанию, нужно задать опции значение `null`
...
| `footnoteCaption` | `Сноски` | Название блока сносок |
